...
namespace engine::collisions {
    ...
    public:
        ...
        virtual bool checkCollisionWithTile(const Vector2& myPos, const Vector2& mySize, const CollisionTile& tile) const = 0;
        virtual bool checkCollisionBetween(const Collision& collision1, const Vector2& pos1, const Collision& collision2, const Vector2& pos2) const = 0;
